  ...
  return [
      ...
      ? [
          {
            title: t(
              ...
              'Am I going to be charged by SocialHub?'
            ),
            description: t(
              'faq_to_confirm_credit_card_information_postiz_will_hold',
              'To confirm credit card information SocialHub will hold $2 and release it immediately, you can cancel your subscription anytime from settings without talking to a person'
            ),
          },
        ]
      : []),
    {
      title: t(
        ...
        'Can I trust SocialHub?'
      ),
      description: t(
        'faq_postiz_gitroom_is_proudly_open_source',
        'SocialHub is proudly open-source! We believe in an ethical and transparent culture, meaning that SocialHub will live forever. You can check out the entire code or use it for personal projects.'
      ),
    },
    {
